...
#     # bot.send_message(chat_id=msg.from_user.id, text=f'Запускаю калькулятор')
#     bot.send_message(chat_id=msg.from_user.id, text=f'Введите число а:')
#     a = msg.text
#     bot.send_message(chat_id=msg.from_user.id, text=a)
#     # b = int(input())
#     # bot.send_message(chat_id=msg.from_user.id, text=f'Сумма = {a+b}')
